...
#manlist_listContainer_leftmenu {
	position: fixed;
	top: 100px;
	left: 20px;
...
#manlist_listcontainer_mainframe{
	width: 1200px;
}
#manlist_listContainer_leftmenu li {
	list-style-type: none;
}

#manlist_listContainer_mainframe_list {
	text-align: center;
}

.manlist_listContainer_mainframe_list_item {
	margin-top: 50px;
	margin-left: 40px;
	width: 260px;
	float: left;
...
#manlist_listContainer_mainframe_list .manlist_listContainer_mainframe_list_item img{
	width: 200px;
	margin-bottom: 10px;
}
.manlist_listContainer_mainframe_list_item:hover{
	outline : 1px solid #ccc;
}
#manlist_listContainer_mainframe_list_item .detail_goods{
	text-align: left;
}
...
<body>
	...
	<div id="manlist_container" class="manlist_container">
		...
		<div id="manlist_listContainer">
			<div id="manlist_listcontainer_mainframe">
				...
				<c:forEach items="${list }" var="i" varStatus="status">
					<a style="color:black" href="detail.do?goodsno=${i.goodsno }&gender=${gender}">
						<div id="manlist_listContainer_mainframe_list">
							<div class="manlist_listContainer_mainframe_list_item">
	...
	<div id="manlist_listContainer_leftmenu">
	...
	<div id="category_leftmenu">
		<ul class="nav nav-pills nav-stacked">
			<li id="running"><a href="list.do?category=러닝화&gender=남성">러닝</a></li>
	  		<li id="sportwear"><a href="list.do?category=스포츠웨어&gender=남성">스포츠웨어</a></li>
	  		<li id="tennis"><a href="list.do?category=테니스&gender=남성">테니스</a></li>
	  		<li id="golf"><a href="list.do?category=골프&gender=남성">골프</a></li>
	  		<li id="basketball"><a href="list.do?category=농구&gender=남성">농구</a></li>
	  		<li id="jordan" ><a href="list.do?category=조던&gender=남성">조던</a></li>
	  		<li id="soccer"><a href="list.do?category=축구&gender=남성">축구</a></li>
		</ul>
	</div>
