...
<script type="text/javascript">
	$(function() {
		$("#category-p").on('click',function(){
			$("#category_leftmenu").toggle();
			if($("#category-value").val()==0)
			{
				$("#category-p").html('카테고리-')
				$("#category-value").val(1);
			}
			else if($("#category-value").val()==1)
			{
				$("#category-p").html('카테고리+')
...
#womanlist_listContainer_leftmenu {
	position: fixed;
	top: 100px;
	left: 20px;
...
#womanlist_listcontainer_mainframe{
	width: 1200px;
}
#womanlist_listContainer_leftmenu li {
	list-style-type: none;
}

#womanlist_listContainer_mainframe_list {
	text-align: center;
}

.womanlist_listContainer_mainframe_list_item {
	margin-top: 50px;
	margin-left: 40px;
	width: 260px;
	float: left;
...
#womanlist_listContainer_mainframe_list .womanlist_listContainer_mainframe_list_item img{
	width: 200px;
	margin-bottom: 10px;
}
.womanlist_listContainer_mainframe_list_item:hover{
	outline : 1px solid #ccc;
}
#womanlist_listContainer_mainframe_list_item .detail_goods{
	text-align: left;
}
...
<body>
	...
	<div id="womanlist_container" class="womanlist_container">
		...
		<div id="womanlist_listContainer">
			<div id="womanlist_listcontainer_mainframe">
				...
				<c:forEach items="${list }" var="i" varStatus="status">
					<a style="color:black" href="detail.do?goodsno=${i.goodsno }&gender=${gender}">
						<div id="womanlist_listContainer_mainframe_list">
							<div class="womanlist_listContainer_mainframe_list_item">
	...
	<div id="womanlist_listContainer_leftmenu">
		...
		<div id="color-list-div" class="nav_link_wrap" style="display:block;"></div>
			...
			<p id="category-p" style="display:block;">카테고리<span id="category_plus">+</span></p>
			<input type="hidden" name="category-value" id="category-value" value="0" />
		</div>
	<div id="category_leftmenu">
		<ul class="nav nav-pills nav-stacked">
			<li id="running"><a href="list.do?category=러닝화&gender=여성">러닝</a></li>
	  		<li id="sportwear"><a href="list.do?category=스포츠웨어&gender=여성">스포츠웨어</a></li>
	  		<li id="tennis"><a href="list.do?category=테니스&gender=여성">테니스</a></li>
	  		<li id="golf"><a href="list.do?category=골프&gender=여성">골프</a></li>
	  		<li id="basketball"><a href="list.do?category=농구&gender=여성">농구</a></li>
	  		<li id="jordan" ><a href="list.do?category=조던&gender=여성">조던</a></li>
	  		<li id="soccer"><a href="list.do?category=축구&gender=여성">축구</a></li>
		</ul>
	</div>
		...
		<ul class="nav" id ="left-color">
			<li>
				<div>
					<a href="list.do?gender=${gender }&color=black">
			...
			<li>
				<div>
					<a href="list.do?gender=${gender }&color=blue">
			...
			<li>
				<div>
					<a href="list.do?gender=${gender }&color=gray">
			...
			<li>
				<div>
					<a href="list.do?gender=${gender }&color=green">
			...
			<li>
				<div>
					<a href="list.do?gender=${gender }&color=navy">
			...
			<li>
				<div>
					<a href="list.do?gender=${gender }&color=orange">
			...
			<li>
				<div>
					<a href="list.do?gender=${gender }&color=pink">
			...
			<li>
				<div>
					<a href="list.do?gender=${gender }&color=purple">
			...
			<li>
				<div>
					<a href="list.do?gender=${gender }&color=red">
			...
			<li>
				<div>
					<a href="list.do?gender=${gender }&color=silver">
			...
			<li>
				<div>
					<a href="list.do?gender=${gender }&color=white">
